...
def run(model_path, image_path, output):
    ...
    #ith_file = 1
    for filename in tqdm.tqdm(file_list_png):
        ...
        pred = outputs[5][0]
        cv2.imwrite(os.path.join(output_path, "Edge_" + filename), pred * 255)
        #ith_file += 1
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--run', help='run model on images', type=str)
